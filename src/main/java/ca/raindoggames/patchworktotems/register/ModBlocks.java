...
public class ModBlocks {
	...
	public static final RegistryObject<SewingMachine> SEWINGMACHINE = BLOCKS.register("sewing_machine", () -> new SewingMachine(BlockBehaviour.Properties.of(Material.METAL).strength(3.0f)));
}
